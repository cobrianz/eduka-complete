                ...
                <div class="signup__form-container">
                    <div class="form">
                        ...
                        <?php if(isset($_SESSION['update-success'])): ?>
                            ...
                            <p>Change your details below, or <a href="#" id="passcode-toggler">click here</a> to change your password.</p>
                            <label id="passcode" class="passcode" for="name">Password *</label>
                            <input id="passcode" class="passcode" type="password" value="" placeholder="<?=$user_record['password']?>">
